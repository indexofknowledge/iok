...
describe('markdown scraper', () => {
  ...
  it('only description resource nodes', () => {
    expect(graphFromText(
      ...
      nodes: [
        ...
        createTestNode(2, "SecondRes", "4faea3d4eb412cea485e9e70c5f8a6", 1, "SecondRes", ""),
        createTestNode(2, "ThirdRes", "c0dd146d647e4eeded368dcae8030c55bbf", 1, "ThirdRes", ""),
      ],
      edges: [],
    })
  });
  ...
  it('only link resource nodes', () => {
    expect(graphFromText(
      ...
      nodes: [
        createTestNode(2, "linkTitle1", "40f38118359d044116aa7954b8c223b5", 2, "linkTitle1", "insertLink1"),
  ...
  it('only same level topic nodes', () => {
    expect(graphFromText(
      ...
      "nodes": [
        ...
        createTestNode(1, "Second Topic", "6890869a8baf91bbf01ef4", null, null, null),
  ...
  it('nested topic nodes', () => {
    expect(graphFromText(
      ...
      edges: [
        createTestEdge("44b392290a2160bcf4", "7f6a3d4c56d4201bb2fcda", "e211c01f4db8f6727eb99275b6"),
        createTestEdge("acee519799f614a9d6a", "b786e851cddca7fa437", "7f6a3d4c56d4201bb2fcda0f1"),
      ]
    })
  });
