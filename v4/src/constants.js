...
export const DEFL_GRAPH_ELEMENTS = {
  nodes: [
    ...
    },
    {
      data: {
        resource_type: 1,
        data: 'Computer science is the study of processes that interact with data and that can be represented as data in the form of programs.',
        node_type: 2,
    ...
    },
    {
      data: {
        resource_type: 1,
        data: 'Economics is the social science that studies the production, distribution, and consumption of goods and services.',
        node_type: 2,
    ...
    },
    {
      data: {
        resource_type: 1,
        data: 'Mathematics is the study of abstract objects and structures that are often, but not always, abstracted from the physical world. It includes the study of such abstractions as quantity, structure, space and shapes, and change.',
        node_type: 2,
    ...
    },
    {
      data: {
        resource_type: 1,
        data: 'Bitcoin is an innovative payment network and a new kind of money.',
        node_type: 2,
